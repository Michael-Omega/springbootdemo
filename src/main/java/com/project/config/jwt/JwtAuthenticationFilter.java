...
//        boolean flag;
//        flag = !pathMatcher.match("/user/login", request.getServletPath()) || pathMatcher.match("/user/register", request.getServletPath()) || pathMatcher.matchStart("/index", request.getServletPath());
//        if (flag){
